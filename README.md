...
The complete analysis can be found in the <a href="aviation_division_FINAL.ipynb" target="_blank">Jupyter Notebook</a> and in our <a href="presentation.pdf">presentation</a>.
